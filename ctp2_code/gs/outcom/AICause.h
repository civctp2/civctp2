...
enum CAUSE_REMOVE_ARMY
{
	...
	CAUSE_REMOVE_ARMY_BOMBARD,                     // 12
	CAUSE_REMOVE_ARMY_SUE,                         // 13
	CAUSE_REMOVE_ARMY_POLLUTION,                   // 14
	CAUSE_REMOVE_ARMY_UPRISING,                    // 15
	CAUSE_REMOVE_ARMY_SLAVE_UPRISING,              // 16
	CAUSE_REMOVE_ARMY_ENSLAVED,                    // 17
	CAUSE_REMOVE_ARMY_DIPLOMACY,                   // 18

	CAUSE_REMOVE_ARMY_NO_MAT_SUPPORT,              // 19

	CAUSE_REMOVE_ARMY_DIED_IN_ATTACK,              // 20
	CAUSE_REMOVE_ARMY_DIED_IN_ATTACK_ON_TOP,       // 21
	CAUSE_REMOVE_ARMY_DIED_IN_SPYING,              // 22
	CAUSE_REMOVE_ARMY_DIED_IN_SLAVERAID,           // 23
	CAUSE_REMOVE_ARMY_DIED_IN_UNDERGROUND_RR_RAID, // 24
	CAUSE_REMOVE_ARMY_DIED_IN_CONVERT_RAID,        // 25
	CAUSE_REMOVE_ARMY_DIED_IN_REFORMATION,         // 26
	CAUSE_REMOVE_ARMY_COUNTERBOMBARD,              // 27
	CAUSE_REMOVE_ARMY_OUTOFFUEL,                   // 28
	CAUSE_REMOVE_ARMY_REENTRY,                     // 29
	CAUSE_REMOVE_ARMY_GOVERNMENT_CHANGE,           // 30
	CAUSE_REMOVE_ARMY_TOE,                         // 31
	CAUSE_REMOVE_ARMY_RUSTLE,                      // 32
	CAUSE_REMOVE_ARMY_LAND_MINES,                  // 33
	CAUSE_REMOVE_ARMY_TRANSPORT_DIED,              // 34
	CAUSE_REMOVE_ARMY_DIDNT_NEED_IT_AFTER_ALL,     // 35
	CAUSE_REMOVE_ARMY_DISBANDED,                   // 36

	CAUSE_REMOVE_ARMY_PARADROP_COMPLETE,           // 37
	CAUSE_REMOVE_ARMY_NUKES_ELIMINATED,            // 38
	CAUSE_REMOVE_ARMY_EMANCIPATION,                // 39
	CAUSE_REMOVE_ARMY_ILLEGAL_CELL,                // 40
	CAUSE_REMOVE_ARMY_EXPELLED_NO_CITIES,          // 41
	CAUSE_REMOVE_ARMY_SCENARIO,                    // 42
	CAUSE_REMOVE_ARMY_PROBE_RECOVERED,             // 43
	CAUSE_REMOVE_ARMY_SINGLE_USE,                  // 44
	CAUSE_REMOVE_ARMY_ACTIVE_DEFENSE,              // 45
	CAUSE_REMOVE_ARMY_TRADE                        // 46
};
