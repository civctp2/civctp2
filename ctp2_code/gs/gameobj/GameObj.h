...
public:
	...
	friend const bool GameObj_Valid(GameObj *p, const uint32 id);

	friend void GameObj_Insert(GameObj **p, GameObj *ins);
	friend bool GameObj_Delete(GameObj **p, const uint32 i);
};
...
bool GameObj_Delete(GameObj **p, const uint32 i);
