...
private:
	...
	{
		printf("\n");
		printf("Data of CityData class:\n");
		printf("m_owner: %d\n", m_owner);
		printf("m_slaveBits: %d\n", m_slaveBits);
		printf("m_accumulated_food: %d\n", m_accumulated_food);
		printf("m_shieldstore: %d\n", m_shieldstore);
		printf("m_shieldstore_at_begin_turn: %d\n", m_shieldstore_at_begin_turn);
		printf("m_build_category_at_begin_turn: %d\n", m_build_category_at_begin_turn);
		printf("m_net_gold: %d\n", m_net_gold);
		printf("m_gold_lost_to_crime: %d\n", m_gold_lost_to_crime);
		printf("m_gross_gold: %d\n", m_gross_gold);
		printf("m_goldFromTradeRoutes: %d\n", m_goldFromTradeRoutes);
		printf("m_goldLostToPiracy: %d\n", m_goldLostToPiracy);
		printf("m_science: %d\n", m_science);
		printf("m_luxury: %d\n", m_luxury);
		printf("m_city_attitude: %d\n", m_city_attitude);
		printf("m_collected_production_this_turn: %d\n", m_collected_production_this_turn);
		printf("m_gross_production: %d\n", m_gross_production);
		printf("m_net_production: %d\n", m_net_production);
		printf("m_production_lost_to_crime: %d\n", m_production_lost_to_crime);
		printf("m_built_improvements: %d\n", m_built_improvements);
		printf("m_builtWonders: %d\n", m_builtWonders);
		printf("m_food_delta: %f\n", m_food_delta);
		printf("m_gross_food: %f\n", m_gross_food);
		printf("m_net_food: %f\n", m_net_food);
		printf("m_food_lost_to_crime: %f\n", m_food_lost_to_crime);
		printf("m_food_consumed_this_turn: %f\n", m_food_consumed_this_turn);
		printf("m_total_pollution: %d\n", m_total_pollution);
		printf("m_cityPopulationPollution: %d\n", m_cityPopulationPollution);
		printf("m_cityIndustrialPollution: %d\n", m_cityIndustrialPollution);
		printf("m_foodVatPollution: %d\n", m_foodVatPollution);
		printf("m_cityPollutionCleaner: %d\n", m_cityPollutionCleaner);
		printf("m_contribute_materials: %d\n", m_contribute_materials);
		printf("m_contribute_military: %d\n", m_contribute_military);
		printf("m_capturedThisTurn: %d\n", m_capturedThisTurn);
		printf("m_spied_upon: %d\n", m_spied_upon);
		printf("m_walls_nullified: %d\n", m_walls_nullified);
		printf("m_franchise_owner: %d\n", m_franchise_owner);
		printf("m_franchiseTurnsRemaining: %d\n", m_franchiseTurnsRemaining);
		printf("m_watchfulTurns: %d\n", m_watchfulTurns);
		printf("m_bioInfectionTurns: %d\n", m_bioInfectionTurns);
		printf("m_bioInfectedBy: %d\n", m_bioInfectedBy);
		printf("m_nanoInfectionTurns: %d\n", m_nanoInfectionTurns);
		printf("m_nanoInfectedBy: %d\n", m_nanoInfectedBy);
		printf("m_convertedTo: %d\n", m_convertedTo);
		printf("m_convertedGold: %d\n", m_convertedGold);
		printf("m_convertedBy: %d\n", m_convertedBy);
		printf("m_terrainWasPolluted: %d\n", m_terrainWasPolluted);
		printf("m_happinessAttacked: %d\n", m_happinessAttacked);
		printf("m_terrainImprovementWasBuilt: %d\n", m_terrainImprovementWasBuilt);
		printf("m_improvementWasBuilt: %d\n", m_improvementWasBuilt);
		printf("m_isInjoined: %d\n", m_isInjoined);
		printf("m_injoinedBy: %d\n", m_injoinedBy);
		printf("m_airportLastUsed: %d\n", m_airportLastUsed);
		printf("m_founder: %d\n", m_founder);
		printf("m_wages_paid: %d\n", m_wages_paid);
		printf("m_pw_from_infrastructure: %d\n", m_pw_from_infrastructure);
		printf("m_gold_from_capitalization: %d\n", m_gold_from_capitalization);
		printf("m_buildInfrastructure: %d\n", m_buildInfrastructure);
		printf("m_buildCapitalization: %d\n", m_buildCapitalization);
		printf("m_paidForBuyFront: %d\n", m_paidForBuyFront);
		printf("m_doUprising: %d\n", m_doUprising);
		printf("m_turnFounded: %d\n", m_turnFounded);
		printf("m_productionLostToFranchise: %d\n", m_productionLostToFranchise);
		printf("m_probeRecoveredHere: %d\n", m_probeRecoveredHere);
		printf("m_lastCelebrationMsg: %d\n", m_lastCelebrationMsg);
		printf("m_alreadySoldABuilding: %d\n", m_alreadySoldABuilding);
		printf("m_population: %d\n", m_population);
		printf("m_partialPopulation: %d\n", m_partialPopulation);
		printf("m_numSpecialists[0]: %d\n", m_numSpecialists[0]);
		printf("m_numSpecialists[1]: %d\n", m_numSpecialists[1]);
		printf("m_numSpecialists[2]: %d\n", m_numSpecialists[2]);
		printf("m_numSpecialists[3]: %d\n", m_numSpecialists[3]);
		printf("m_numSpecialists[4]: %d\n", m_numSpecialists[4]);
		printf("m_numSpecialists[5]: %d\n", m_numSpecialists[5]);
		printf("m_numSpecialists[6]: %d\n", m_numSpecialists[6]);
		printf("m_specialistDBIndex[0]: %d\n", m_specialistDBIndex[0]);
		printf("m_specialistDBIndex[1]: %d\n", m_specialistDBIndex[1]);
		printf("m_specialistDBIndex[2]: %d\n", m_specialistDBIndex[2]);
		printf("m_specialistDBIndex[3]: %d\n", m_specialistDBIndex[3]);
		printf("m_specialistDBIndex[4]: %d\n", m_specialistDBIndex[4]);
		printf("m_specialistDBIndex[5]: %d\n", m_specialistDBIndex[5]);
		printf("m_specialistDBIndex[6]: %d\n", m_specialistDBIndex[6]);
		printf("m_sizeIndex: %d\n", m_sizeIndex);
		printf("m_workerFullUtilizationIndex: %d\n", m_workerFullUtilizationIndex);
		printf("m_workerPartialUtilizationIndex: %d\n", m_workerPartialUtilizationIndex);
		printf("m_useGovernor: %d\n", m_useGovernor);
		printf("m_buildListSequenceIndex: %d\n", m_buildListSequenceIndex);
		printf("m_garrisonOtherCities: %d\n", m_garrisonOtherCities);
		printf("m_garrisonComplete: %d\n", m_garrisonComplete);
		printf("m_currentGarrison: %d\n", m_currentGarrison);
		printf("m_neededGarrison: %d\n", m_neededGarrison);
		printf("m_currentGarrisonStrength: %f\n", m_currentGarrisonStrength);
		printf("m_neededGarrisonStrength: %f\n", m_neededGarrisonStrength);
		printf("m_sellBuilding: %d\n", m_sellBuilding);
		printf("m_buyFront: %d\n", m_buyFront);
		printf("m_max_food_from_terrain: %d\n", m_max_food_from_terrain);
		printf("m_max_prod_from_terrain: %d\n", m_max_prod_from_terrain);
		printf("m_max_gold_from_terrain: %d\n", m_max_gold_from_terrain);
		printf("m_growth_rate: %d\n", m_growth_rate);
		printf("m_overcrowdingCoeff: %f\n", m_overcrowdingCoeff);
		printf("m_starvation_turns: %d\n", m_starvation_turns);
		printf("m_cityStyle: %d\n", m_cityStyle);
		printf("m_pos: %d, %d\n", m_pos.x, m_pos.y);
		printf("m_is_rioting: %d\n", m_is_rioting);
		printf("m_build_category_before_load_queue: %d\n", m_build_category_before_load_queue);
		printf("m_scie_lost_to_crime: %d\n", m_scie_lost_to_crime);
		printf("m_gross_food_before_bonuses: %f\n", m_gross_food_before_bonuses);
		printf("m_gross_prod_before_bonuses: %d\n", m_gross_prod_before_bonuses);
		printf("m_happinessAttackedBy: %d\n", m_happinessAttackedBy);
		printf("m_home_city: %d\n", m_home_city.m_id);
		printf("m_min_turns_revolt: %d\n", m_min_turns_revolt);
		printf("m_build_queue: %x\n", m_build_queue);
		printf("m_tradeSourceList: %x\n", m_tradeSourceList);
		printf("m_tradeDestinationList: %x\n", m_tradeDestinationList);
		printf("m_collectingResources: %x\n", m_collectingResources);
		printf("m_sellingResources: %x\n", m_sellingResources);
		printf("m_buyingResources: %x\n", m_buyingResources);
		printf("m_happy: %x\n", m_happy);
		printf("m_name: %s\n", m_name);
		printf("m_distanceToGood: %x\n", m_distanceToGood);
		printf("m_defensiveBonus: %f\n", m_defensiveBonus);
		printf("m_ringFood: %x\n", m_ringFood);
		printf("m_ringProd: %x\n", m_ringProd);
		printf("m_ringGold: %x\n", m_ringGold);
		printf("m_ringSizes: %x\n", m_ringSizes);
		printf("m_bonusFoodCoeff: %f\n", m_bonusFoodCoeff);
		printf("m_bonusFood: %f\n", m_bonusFood);
		printf("m_bonusProdCoeff: %f\n", m_bonusProdCoeff);
		printf("m_bonusProd: %f\n", m_bonusProd);
		printf("m_bonusGoldCoeff: %f\n", m_bonusGoldCoeff);
		printf("m_bonusGold: %f\n", m_bonusGold);
		printf("m_bonusScieCoeff: %f\n", m_bonusScieCoeff);
		printf("m_bonusScie: %f\n", m_bonusScie);
		printf("m_cityRadiusOp: %d\n", m_cityRadiusOp);
		printf("m_killList: %x\n", m_killList);
		printf("m_radiusNewOwner: %d\n", m_radiusNewOwner);
		printf("m_tilecount: %d\n", m_tilecount);
		printf("m_whichtile: %d\n", m_whichtile);
		printf("m_tempGoodAdder: %x\n", m_tempGoodAdder);
		printf("m_tempGood: %d\n", m_tempGood);
		printf("m_tempGoodCount: %d\n", m_tempGoodCount);
		printf("m_sentInefficientMessageAlready: %d\n", m_sentInefficientMessageAlready);
		printf("m_culture: %d\n", m_culture);
		printf("m_secthappy: %d\n", m_secthappy);
		printf("\n");
	}
#endif
};
