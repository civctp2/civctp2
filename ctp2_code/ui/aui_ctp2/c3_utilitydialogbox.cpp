...
c3_UtilityTextFieldPopup::c3_UtilityTextFieldPopup( c3_UtilityTextFieldCallback* callback,
    ...
    const MBCHAR *messageText, const MBCHAR *ldlBlock, void *data,
    bool wantEmpties)
{
	AUI_ERRCODE errcode = AUI_ERRCODE_OK;
	MBCHAR		windowBlock[ k_AUI_LDL_MAXBLOCK + 1 ];
...
c3_UtilityTextMessagePopup::c3_UtilityTextMessagePopup( MBCHAR const *text, sint32 type, c3_UtilityTextMessageCallback* callback,  MBCHAR const *ldlBlock )
{
	AUI_ERRCODE errcode = AUI_ERRCODE_OK;
	MBCHAR		windowBlock[ k_AUI_LDL_MAXBLOCK + 1 ];
...
c3_UtilityTextMessageCreateAction::c3_UtilityTextMessageCreateAction( MBCHAR const *text, sint32 type, c3_UtilityTextMessageCallback *callback, MBCHAR const *ldlBlock )
{
	m_text = text;
	m_type = type;
	m_callback = callback;
...
DoubleListItem::DoubleListItem(AUI_ERRCODE *retval, const MBCHAR *name, sint32 value,
...
AUI_ERRCODE DoubleListItem::InitCommonLdl(const MBCHAR *name,sint32 value,
    const MBCHAR *text, const MBCHAR *ldlBlock)
{
