...
{
public:
	MessageResponseListItem(AUI_ERRCODE *retval, MBCHAR const * name, sint32 index, const MBCHAR *ldlBlock);
...
protected:
	...
	AUI_ERRCODE InitCommonLdl(MBCHAR const * name, sint32 index, const MBCHAR *ldlBlock);
