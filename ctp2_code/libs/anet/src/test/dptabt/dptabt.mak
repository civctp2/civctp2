...
dptabt.exe: dptabt.c
	cl /DLOOPBACK_ADDRESS -Fm -W3 -Zi /MDd -DDPRNT /D "_CRT_SECURE_NO_DEPRECATE" /D "_CRT_NONSTDC_NO_DEPRECATE" /D "WINDOWS_IGNORE_PACKING_MISMATCH" dptabt.c ../../../demo/utils/unistd.c -I../../../h ../../../win/lib/dp2d.lib kernel32.lib user32.lib advapi32.lib version.lib
