...
cl -MDd /D "_CRT_SECURE_NO_DEPRECATE" /D "_CRT_NONSTDC_NO_DEPRECATE" /D "WINDOWS_IGNORE_PACKING_MISMATCH" -Zi -I%MYJDK%\include -I%MYJDK%\include\win32 -I%MYASDK%\h -I..\..\..\demo\utils -LD -DDPRNT -Ddp_ANET2 -DWIN32 ANetj.c ..\..\..\demo\utils\eclock.c %MYASDK%\win\lib\anet2d.lib -FeANetj2d.dll advapi32.lib > dlog2
...
cl -MD  /D "_CRT_SECURE_NO_DEPRECATE" /D "_CRT_NONSTDC_NO_DEPRECATE" /D "WINDOWS_IGNORE_PACKING_MISMATCH" -Zi -I%MYJDK%\include -I%MYJDK%\include\win32 -I%MYASDK%\h -I..\..\..\demo\utils -LD -Ddp_ANET2 -DWIN32 ANetj.c ..\..\..\demo\utils\eclock.c %MYASDK%\win\lib\anet2.lib -FeANetj2.dll advapi32.lib > log2
